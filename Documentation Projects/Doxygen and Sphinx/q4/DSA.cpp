...
// void main(){
//    SinglyLinkedListNode singlyllistnode;
//    out<< singlyllistnode;
//    SinglyLinkedListNode singlyllistnode1(10);
//    out<< singlyllistnode1;
//    SinglyLinkedList singlyllist;
//    singlyllist.insert(5);
//    singlyllist.insert(5);
//    singlyllist.find(5);
//    singlyllist.deleteVal(5);
//    singlyllist.printer();
//    singlyllist.reverse();
//    DoublyLinkedListNode doublyllistnode;
//    out<< doublyllistnode;
//    DoublyLinkedListNode doublyllistnode1(10);
//    out<< doublyllistnode;
//    DoublyLinkedList doublyllist;
//    doublyllist.insert(5);
//    doublyllist.insert(5);
//    doublyllist.find(5);
//    doublyllist.deleteVal(5);
//    doublyllist.printer();
//    doublyllist.reverse();
//    BSTNode bstnode(10);
